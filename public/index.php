...
$query=" SELECT * FROM visitatore WHERE email='$username'";
echo $query;
...
while($row=mysqli_fetch_array($RicercaLogin)) {
  ...
  ?>
 <?php if(isset($_POST['login_staff'])){
...
<h4 class="bg-warning text-center"></h4>
        ...
        <h6>Email: mariorossi@gmail.com </h6>
        <h6>Password: 0000 </h6>
        <hr>
        ...
        <form class="form-horizontal" role="form" method="post" action="index.php">
            ...
            <div class="row" style="padding-top: 1rem">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <button type="submit" name="login_staff" class="btn btn-success btn-block">Login</button>
               
                </div>
            </div>
        </form>
        <h6>Numero Matricola: 1111</h6>
        <h6>Password: 0000 </h6>
    </div>
</body>
</html>